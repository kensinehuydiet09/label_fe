  ...
  export const CreateProjectDialog = ({ open, onClose }) => {
    ...
    // Calculate remaining balance after this project
    const getProjectCost = () => {
      return fileData?.data?.totalPrice || 0;
    };
    
    const getRemainingBalance = () => {
      return (balance - getProjectCost()).toFixed(2);
    };

    // Check if user has enough balance
    const hasEnoughBalance = () => {
      return balance >= getProjectCost();
    };
              ...
              {uploadSuccess && fileData && !isUploading && !isSubmitting && (
                <>
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mt-4">
                    ...
                    {/* New section for account balance */}
                    <div className="bg-white p-4 rounded-md mb-3 border border-green-100">
                      ...
                      <div className="grid grid-cols-2 gap-4 mt-2">
                        <div className="p-2 bg-gray-50 rounded-md">
                          ...
                          <p className="font-medium text-blue-700">{balance} USD</p>
                        </div>
                        
                        <div className={`p-2 rounded-md ${hasEnoughBalance() ? 'bg-green-50' : 'bg-red-50'}`}>
                          <p className="text-xs text-muted-foreground mb-1">After This Project</p>
                          <p className={`font-medium ${hasEnoughBalance() ? 'text-green-700' : 'text-red-700'}`}>
                            {getRemainingBalance()} USD
                          </p>
                        </div>
                      </div>
                      ...
                      {!hasEnoughBalance() && (
                        <Alert variant="destructive" className="mt-3 py-2">
                          ...
                          <AlertDescription className="text-xs">
                            You need to add funds to your account to create this project.
                          </AlertDescription>
                        </Alert>
                      )}
                    </div>
          ...
          <DialogFooter className="gap-2 sm:justify-start">
            ...
            <Button
              ...
              disabled={
                ...
                isUploading ||
                isSubmitting ||
                (uploadSuccess && !hasEnoughBalance())
              }
