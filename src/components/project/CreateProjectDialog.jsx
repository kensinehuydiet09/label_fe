  ...
  const handleConfirmCreateProject = async () => {
    try {
      ...
      if (response.success) {
        ...
        setFileError(response.message || "Failed to create project. Please try again.");
      }
    } catch (error) {
      console.error("Error creating project:", error);
      setFileError("Failed to create project. Please try again.");
      setConfirmDialogOpen(false);
    }
  };
        ...
        <DialogContent className="sm:max-w-[550px]">
          ...
          <div className="py-4">
            ...
            <div className="space-y-4 mt-0">
              ...
              {uploadSuccess && fileData && !isUploading && (
                <>
      ...
      <AlertDialog open={confirmDialogOpen} onOpenChange={setConfirmDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              You are about to create a new project named "{projectName}".
              {selectedFile && (
